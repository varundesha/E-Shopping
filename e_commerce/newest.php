...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#121212">
   ...
   <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
    <form action="newest.php" method="post" class="form-inline my-2 my-lg-0">
...
$result = mysqli_query($con,"SELECT * FROM category where Ca_Name like '%$search%' or Ca_Details like '%$search%' order by Ca_Id desc");
